      ...
      {allColumns.map((col) => {
        ...
        return (
          <div
            ...
            className="w-80 shrink-0 bg-zinc-900/40 border border-zinc-800/80 rounded-2xl flex flex-col max-h-[calc(100vh-140px)] shadow-xl"
          >
            {/* Column Header */}
            <div className="p-3.5 border-b border-zinc-800/80 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-zinc-200 tracking-tight">{col.name}</span>
                <span className="px-2 py-0.5 rounded-full bg-zinc-800 text-zinc-400 font-mono text-[10px] font-bold">
                  {colTasks.length}
                </span>
              </div>
