-- ==============================================================================
-- Migration: 20260905000001_fix_ambiguous_columns_in_admin_rpcs.sql
-- Description: Adds #variable_conflict use_variable to admin RPCs to resolve
--              'column reference "request_id" is ambiguous' errors during PL/pgSQL
--              execution of IF request_id IS NOT NULL condition.
-- ==============================================================================
